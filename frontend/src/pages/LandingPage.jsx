        ...
        <div className="dashboard-body">
          ...
          <div className="dashboard-requirements">
            ...
            <div className="requirements-body">
              <ul>
                <li>
                  <p>A user must be member of the society/organization.</p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    ...
                    the society/organization for more than 3 months.
                  </p>
                </li>
                <li>
                  <p>
                    Loans are only granted if requested loan amount is maximum
